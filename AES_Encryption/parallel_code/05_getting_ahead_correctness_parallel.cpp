 ...
 */
 ...
 double totalSubBytesTime = 0.0;
 double totalShiftRows = 0.0;
 double totalMixColumns = 0.0;
 double nineRounds = 0.0;
...
void AddRoundKey(unsigned char * state, unsigned char * roundKey) {
	...
	// totalAddRoundKeyTime += tdata;
	// cout<<"Time taken to AddRoundKey (parallel) :"<<tdata<<endl;
...
clock_t tStart = clock();
	...
	cout<<"padded msg length : "<<paddedMessageLen<<endl;
	KeyExpansion(key, expandedKey);

	// encrypting envery 16bytes of message :
	// double tdata = omp_get_wtime();
	// omp_set_num_threads(4);
	// #pragma omp parallel
	// {
		...
		// if(id == 0){
		// 	cout<<"Threads available : "<< nthreads<<endl;
		// }
		// cout<<"thread "<<id<<"is encrypting a block of 16bytes \n"<<endl;
		// printf("thread %d is encrypting a block of 16bytes \n",id);
		// #pragma omp for
	...
	// }
	// tdata = omp_get_wtime()-tdata;
	// cout<<"Time taken to encrypt  :"<<tdata<<endl;


	// cout<<"Time taken to AddRoundKey : "<<totalAddRoundKeyTime<<endl;
	// cout<<"Time taken to SubBytes :"<<totalSubBytesTime<<endl;
	// cout<<"Time taken to ShiftRows:"<<totalShiftRows<<endl;
	// cout<<"Time taken to MixColumns:"<<totalMixColumns<<endl;
	cout <<"Time taken to perform 9 rounds :"<<nineRounds<<endl;
...
printf("Time taken by parallel nine rounds : %.6fs\n", (double)(clock() - tStart)/CLOCKS_PER_SEC);
	return 0;
}
